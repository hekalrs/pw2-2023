  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <div class="col-8">
                    <select id="nama" required="required" name="nama" class="form-select">
                        <option value="">----- Pilih kartu -----</option>
                        <option>Gold Utama</option>
                        <option>Platinum jaya</option>
                        <option>Silver</option>
                        <option>NON Member</option>
                    </select <?php if(isset($row['nama'])) echo $row['nama']; ?>>
                </div>
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        value="<?php if(isset($row['diskon'])) echo $row['diskon']; ?>" type="number" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
